...
**审计日期**: 2026-09-24（UTC 2026-09-24T07-42-10Z）
...
| ℹ️ INFO | 审计时刻(UTC) | `2026-09-24T07:42:10Z` |  |
...
| 结果 | 检查项 | 实际值 | 期望/说明 |
|------|--------|--------|----------|
| ℹ️ INFO | R5-01 租户1 ACT_RU_TASK | `158` | （round5 基线 312） |
| ✅ 改善 | R5-01 改善 | 当前 158 < 基线 312 | 残留已部分清理 |
| ℹ️ INFO | R5-02 ACT_RE_DEPLOYMENT | `1051` | （round5 基线 1023） |
| ℹ️ INFO | R6-01 近30天备份 | `总=30 成功=30 成功率=100%` |  |
| ✅ PASS | R6-01 备份成功率 | 100% | ≥95% |
| ℹ️ INFO | R6-02 日志三表 | `audit=0 login=2824 oper=2695` | （round6 基线全 0，功能未接线） |
| ℹ️ INFO | R6-03 sys_user_project | `总=8 项目孤儿=0 用户孤儿=0` | （round6 基线 1287） |
| ℹ️ INFO | R6-04 sys_login_device | `5737` | （round6 基线 17260） |
| ✅ PASS | Flyway 失败迁移 | `0` | 期望 eq `0` |
| ℹ️ INFO | Flyway 总记录 | `80` |  |
...
| ❌ FAIL | CBS actual_amount vs TXN(ACTUAL) 汇总 | `27` | 期望 eq `0` |
| ❌ FAIL | CBS commitment_amount vs TXN(COMMITMENT) 汇总 | `23` | 期望 eq `0` |
...
```
ACT_GE_BYTEARRAY	131543
ACT_HI_ACTINST	8020
ACT_HI_VARINST	7930
sys_login_device	5628
...
ACT_HI_COMMENT	1581
```
| ℹ️ INFO | 碎片率>30% 的表数 | `9` | （仅观察，不触发 OPTIMIZE） |
...
🔴 **数据存在问题**：发现 2 项 FAIL 级缺陷，需立即处置。

---

**报告生成时间**: 2026-09-24T07:42:20Z
