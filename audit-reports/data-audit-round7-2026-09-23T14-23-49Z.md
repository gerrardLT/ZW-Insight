...
**审计日期**: 2026-09-23（UTC 2026-09-23T14-23-53Z）
...
| ℹ️ INFO | 总表数 | `241` | （round6 基线 213） |
| ℹ️ INFO | 表分布 | `biz=142 sys=27 bd=6 ACT=39 wf=7 other=20` |  |
| ℹ️ INFO | 审计时刻(UTC) | `2026-09-23T14:23:59Z` |  |
...
| ℹ️ INFO | R6-02 日志三表 | `audit=0 login=2809 oper=2624` | （round6 基线全 0，功能未接线） |
| ℹ️ INFO | R6-03 sys_user_project | `总=8 项目孤儿=0 用户孤儿=0` | （round6 基线 1287） |
| ℹ️ INFO | R6-04 sys_login_device | `5722` | （round6 基线 17260） |
| ✅ PASS | Flyway 失败迁移 | `0` | 期望 eq `0` |
| ℹ️ INFO | Flyway 总记录 | `73` |  |
