...
**审计日期**: 2026-09-24（UTC 2026-09-24T09-29-28Z）
...
| ℹ️ INFO | 总表数 | `242` | （round6 基线 213） |
| ℹ️ INFO | 表分布 | `biz=143 sys=27 bd=6 ACT=39 wf=7 other=20` |  |
| ℹ️ INFO | 审计时刻(UTC) | `2026-09-24T09:29:29Z` |  |
...
| 结果 | 检查项 | 实际值 | 期望/说明 |
|------|--------|--------|----------|
| ℹ️ INFO | R5-01 租户1 ACT_RU_TASK | `159` | （round5 基线 312） |
| ✅ 改善 | R5-01 改善 | 当前 159 < 基线 312 | 残留已部分清理 |
| ℹ️ INFO | R5-02 ACT_RE_DEPLOYMENT | `1051` | （round5 基线 1023） |
| ℹ️ INFO | R6-01 近30天备份 | `总=30 成功=30 成功率=100%` |  |
| ✅ PASS | R6-01 备份成功率 | 100% | ≥95% |
| ℹ️ INFO | R6-02 日志三表 | `audit=0 login=2827 oper=2712` | （round6 基线全 0，功能未接线） |
| ℹ️ INFO | R6-03 sys_user_project | `总=8 项目孤儿=0 用户孤儿=0` | （round6 基线 1287） |
| ℹ️ INFO | R6-04 sys_login_device | `5740` | （round6 基线 17260） |
| ✅ PASS | Flyway 失败迁移 | `0` | 期望 eq `0` |
| ℹ️ INFO | Flyway 总记录 | `81` |  |
...
| ℹ️ INFO | biz_cost_account_txn 行数 | `50` |  |
...
| ✅ PASS | CBS actual_amount vs TXN(ACTUAL) 汇总 | `0` | 期望 eq `0` |
| ✅ PASS | CBS commitment_amount vs TXN(COMMITMENT) 汇总 | `0` | 期望 eq `0` |
...
```
ACT_GE_BYTEARRAY	135.06	131087
ACT_HI_VARINST	12.61	7695
ACT_HI_ACTINST	7.98	7745
sys_login_device	6.34	5408
ACT_HI_IDENTITYLINK	4.00	4595
ACT_HI_TASKINST	1.95	1805
sys_oper_log	1.72	2475
ACT_HI_PROCINST	0.89	1174
ACT_RU_VARIABLE	0.78	843
...
```
ACT_GE_BYTEARRAY	131087
ACT_HI_ACTINST	7745
ACT_HI_VARINST	7695
sys_login_device	5408
ACT_HI_IDENTITYLINK	4595
sys_login_log	2749
sys_oper_log	2475
wf_approval_record	2135
ACT_HI_TASKINST	1805
ACT_HI_COMMENT	1432
```
...
| ℹ️ INFO | biz_ 表 FK 列缺索引数 | `58` | （project_id/tenant_id/contract_id） |
