...
**审计日期**: 2026-09-18（UTC 2026-09-18T01-52-21Z）
...
| ℹ️ INFO | 审计时刻(UTC) | `2026-09-18T01:52:25Z` |  |
...
| ❌ FAIL | `biz_machine_contract.cumulative_settlement` vs `biz_machine_settlement.SUM(settlement_amount)` | 1/8 MISMATCH | 见下方抽样 |

<details><summary>MISMATCH 抽样前 10 行</summary>

```
2089386615363399682	1	3000.00	0.00	3000.00
```
</details>
| ℹ️ INFO | biz_machine_work_settlement(已审批) | `笔数=10 金额=279000.00` | （无 contract_id，不计入合同勾稽） |
...
🔴 **数据存在问题**：发现 11 项 FAIL 级缺陷，需立即处置。

---

**报告生成时间**: 2026-09-18T01:53:15Z
