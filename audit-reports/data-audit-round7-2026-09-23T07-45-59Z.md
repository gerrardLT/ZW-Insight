...
**审计日期**: 2026-09-23（UTC 2026-09-23T07-46-02Z）
...
| ℹ️ INFO | 审计时刻(UTC) | `2026-09-23T07:46:08Z` |  |
...
| ℹ️ INFO | R6-02 日志三表 | `audit=0 login=2804 oper=2601` | （round6 基线全 0，功能未接线） |
| ℹ️ INFO | R6-03 sys_user_project | `总=8 项目孤儿=0 用户孤儿=0` | （round6 基线 1287） |
| ℹ️ INFO | R6-04 sys_login_device | `5717` | （round6 基线 17260） |
| ✅ PASS | Flyway 失败迁移 | `0` | 期望 eq `0` |
| ℹ️ INFO | Flyway 总记录 | `72` |  |
