...
L5: Frontend E2E (Playwright) - 真实模式/Mock 模式/一致性模式
  ↓
...
### 2.1 当前矩阵 (截至 2026-08-05)
 ...
 zw-finance: 64.8% (⚠️ Near Target)
 zw-contract: 62.0% (✅ = Baseline)
 zw-subcontract: 62.5% (✅ = Baseline)
 zw-security: 53.6% (⚠️ Phase2)
 zw-project: 51.0% (⚠️ Observation)
 zw-machine: 49.0% (⚠️ Observation)
