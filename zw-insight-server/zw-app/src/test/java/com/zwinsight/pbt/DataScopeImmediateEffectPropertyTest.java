...
class DataScopeImmediateEffectPropertyTest {
    ...
    /**
     * 验证设置单个 dataScope 后，getUserDataScopes 立即返回包含该值的列表
     */
    @Property(tries = 100)
    ...
    /**
     * 验证更新 dataScope 后，getEffectiveScope 返回新的有效范围
     */
    @Property(tries = 100)
    ...
    /**
     * 验证连续两次修改 dataScope，最终结果反映最后一次设置
     */
    @Property(tries = 100)
    ...
    /**
     * 验证多角色场景：添加多个 scope 后，getEffectiveScope 返回最高优先级
     */
    @Property(tries = 100)
