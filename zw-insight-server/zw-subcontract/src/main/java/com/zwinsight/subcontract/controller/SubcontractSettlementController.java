...
public class SubcontractSettlementController {
    ...
    @GetMapping("/{id}")
    public R<BizSubcontractSettlement> getById(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public R<Void> update(@PathVariable Long id, @RequestBody BizSubcontractSettlement settlement) {
        settlement.setId(id);
