-- 33_V2026_31: 进度计划(biz_schedule_plan) 补充 responsible(负责人) 字段
-- （与 zw-app/src/main/resources/db/migration/V2026_31__schedule_plan_responsible.sql 内容一致，供全量部署脚本按序执行）
--
-- 背景：
