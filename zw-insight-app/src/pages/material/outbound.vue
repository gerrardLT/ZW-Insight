...
.scan-btn { margin-left: 16rpx; padding: 6rpx 20rpx; background: var(--zw-brand); color: var(--zw-on-primary); font-size: 24rpx; border-radius: var(--zw-radius-xs); flex-shrink: 0; } /* 橙底深字承重规则 */
