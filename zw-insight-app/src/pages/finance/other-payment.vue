  ...
  <view class="form-page">
    <view class="form-section">
      <view class="form-item" @click="showProjectPicker = true">
        ...
        <view class="form-input picker"><text :class="{placeholder:!form.projectName}">{{form.projectName||'请选择项目'}}</text><text class="arrow">›</text></view>
      </view>
    </view>
    <view class="form-section">
      <view class="form-item"><text class="form-label">费用类型</text><input v-model="form.feeType" placeholder="请输入费用类型" class="form-input"/></view>
      <view class="form-item"><text class="form-label">付款金额(元)</text><input v-model="form.amount" type="digit" placeholder="请输入金额" class="form-input"/></view>
      <view class="form-item"><text class="form-label">收款方</text><input v-model="form.payeeName" placeholder="请输入收款方" class="form-input"/></view>
      <view class="form-item"><text class="form-label">收款账号</text><input v-model="form.payeeAccount" placeholder="请输入收款账号" class="form-input"/></view>
      <view class="form-item"><text class="form-label">开户行</text><input v-model="form.payeeBank" placeholder="请输入开户行" class="form-input"/></view>
...
const form=ref({projectId:null as number|null,projectName:'',feeType:'',amount:'',payeeName:'',payeeAccount:'',payeeBank:'',purpose:'',remark:''})
