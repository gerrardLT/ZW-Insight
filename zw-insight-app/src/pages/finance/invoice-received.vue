...
.picker-panel { width: 100%; max-height: 60vh; background: var(--zw-bg-card); border-radius: var(--zw-radius-md) var(--zw-radius-md) 0 0; padding: 20rpx; min-height: 44px; overflow-y: auto; }
