  ...
  <view class="form-page">
    ...
    <view class="form-section">
      ...
      <view class="form-item">
        ...
        <input v-model="form.contractName" placeholder="请输入合同名称" class="form-input" />
      </view>
      <view class="form-item">
...
import { getProjectList, savePaymentReceived } from '@/api/common'
