<template>
  <svg
    ...
    :class="['zw-icon', 'zw-icon-cost-five-state', customClass]"
    aria-hidden="true"
  >
    <!-- 成本五态轨道：基准(1) -> 当前(2) -> 承诺(3) -> 实际(4) -> 预测(5) -->
    <path d="M3 18V6" stroke="currentColor" stroke-width="2" stroke-linecap="square" />
