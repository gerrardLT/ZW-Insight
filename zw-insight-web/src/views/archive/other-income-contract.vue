<template>
  <div class="archive-container">
    <el-card shadow="never">
      <el-alert
        title="其它收入合同档案为只读聚合视图，数据来源于合同模块，此处仅供查询"
        type="info"
        show-icon
        :closable="false"
...
import { getOtherIncomeContractArchive } from '@/api/archive'
...
async function loadData() {
  loading.value = true
  try {
    const res: any = await getOtherIncomeContractArchive(queryParams.value)
